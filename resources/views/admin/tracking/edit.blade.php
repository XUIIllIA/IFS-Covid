                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kasus.update', $kasus->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                    @livewire('tracking-data',['selectedRw'=>$kasus->id_rw,'selectedKelurahan'=>$kasus->rw->id_kelurahan,
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="reaktif" class="form-control" value="{{ $kasus->reaktif }}"
                                            required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal" class="form-control" value="{{ $kasus->tanggal }}"
                                            required>
                                    </div>
                                </div>
                            </div>
