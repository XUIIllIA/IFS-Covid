                        ...
                        <div class="form-group">
                            <div class="mb-12">
                                <label for="">Kelurahan @error('nama_kelurahan')
                                    | <i style="color: red"> {{ $message }} </i>
                                    @enderror</label>
                                <input type="text" class="form-control @error('nama_kelurahan') is-invalid @enderror" value="{{@old('nama_kelurahan')}}" placeholder="Masukan Kelurahan" name="nama_kelurahan">
                            </div>
                        </div>
                        <div class="form-group">
