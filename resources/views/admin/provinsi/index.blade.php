      ...
      @if (session('message'))
          ...
          <div class="card">
            <div class="card-header">{{ __('Data Provinsi') }}
              <a href="{{route('provinsi.create')}}" class="float-right btn btn-info">Add Data</a>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                        ...
                        @foreach($provinsi as $data)
                          <tr>
                              ...
                              <td><form action="{{route('provinsi.destroy',$data->id)}}" method="post">
                                  ...
                                  @method('DELETE')
                                  <center>
                                  <a href="{{route('provinsi.edit',$data->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></a></i>
