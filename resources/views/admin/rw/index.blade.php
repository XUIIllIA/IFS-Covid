  ...
  <div class="row justify-content-center">
      ...
      @if (session('message'))
          ...
          <div class="card">
              ...
              <a href="{{route('rw.create')}}" class="float-right btn btn-info">Add Data</a>
          </div>
                  ...
                  <tbody>
                        ...
                        @foreach($rw as $data)
                          <tr>
                              ...
                              <td><center>{{$data->nama_rw}}</center></td>
                              <td><form action="{{route('rw.destroy',$data->id)}}" method="post">
                                  @csrf
                                  @method('DELETE')
                                  <center>
                                  <a href="{{route('rw.edit',$data->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></a></i>
