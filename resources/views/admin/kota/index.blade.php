    ...
    <div class="row justify-content-center">
        ...
        @if (session('message'))
            ...
            <div class="card-header">{{ __('Data Kota') }}
                <a href="{{route('kota.create')}}" class="float-right btn btn-success">Add Data</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                      <tr class="bg-blue"> <!--bg-teal -->
                         ...
                         @foreach($kota as $data)
                            <tr>
                                ...
                                <td><form action="{{route('kota.destroy',$data->id)}}" method="post">
                                    ...
                                    @method('DELETE')
                                    <center>
                                    <a href="{{route('kota.edit',$data->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></a></i>
