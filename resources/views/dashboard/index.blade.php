        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              ...
              <span data-toggle="counter-up"><?php echo $dupos['value'] ?></span>
              <p>Orang</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-md-0">
            <div class="count-box">
              ...
              <span data-toggle="counter-up"><?php echo $dusem['value'] ?></span>
              <p>Orang</p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
            <div class="count-box">
              ...
              <span data-toggle="counter-up"><?php echo $dumen['value'] ?></span>
              <p>Orang</p>
            </div>
          </div>
