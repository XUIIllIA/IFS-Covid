        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center"
                    ...
                    <img src="{{ asset('assets/frontend/images/left-image.png') }}"
                        class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
                <div class="col-lg-1"></div>
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="left-heading">
                        <h2 class="section-title">Apa itu virus covid ?</h2>
                    </div>
                    <div class="left-text">
                        <p>Covid merupakan keluarga besar virus yang menyebabkan
                            infeksi saluran pernapasan atas ringan hingga sedang, seperti penyakit flu.
                            Banyak orang terinfeksi virus ini, setidaknya satu kali dalam hidupnya. Virus ini sangat
                            membahayakan sekali dapat menyerang pernafasan paru-paru dan menyebabkan kematian.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item">
                        <div class="team-content">
                            <i><img src="{{ asset('assets/frontend/images/testimonial-icon.png') }}" alt=""></i>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="{{ asset('assets/frontend/images/blog-item-01.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="{{ asset('assets/frontend/images/blog-item-02.png') }}" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="{{ asset('assets/frontend/images/blog-item-03.png') }}" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
